...
<body>
    ...
    <nav class="navbar">
        <div class="max-width">
            <div class="logo"><a href="#">Effortless<span>Beauty</span></a></div>
            <ul class="menu">
                <li><a href="#home" class="menu-btn">Home</a></li>
                <li><a href="#Login" class="menu-btn">Login</a></li>
               
                <li><a href="#Staff" class="menu-btn">About Us</a></li>
    ...
    <section class="home" id="home">
        <div class="max-width">
            <div class="home-content">
                ...
                <div class="text-2">Effortless Beauty</div>
    ...
    <section class="services" id="Login">
        <div class="max-width">
            ...
            <div class="serv-content">
             <div class="card">
             <a href="loginpage/index.html">  <div class="box">
                        <i class="fas fa-user"></i>
                        <div class="text">Customer</div>
                        <p> For the Users </p>
                    </div>
               </div></a>
                 <a href="loginpage/index.html"target="_blank"> <div class="card">
                    <div class="box">
                    ...
                    <div class="icons">
                        <div class="row">
                            ...
                            <div class="info">
                                ...
                                <div class="sub-title">Effortless Beauty</div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="info">
                                ...
                                <div class="sub-title">info@effortlessbeauty.com</div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="info">
                                ...
                                <div class="sub-title">01-123456</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <form action="" method="post">
                        <div class="fields">
                            ...
                            <div class="field email">
                                <input type="email" name="Email" placeholder="xyz@gmail.com" class="input-responsive" required>
                            </div>
                        </div>
                        
                        <div class="field">
                            <input type="tel" name="contact" placeholder="98********" class="input-responsive" required>
                        </div>
                        <div class="field">
                            <input type="text" name="Subject" placeholder="Message" class="input-responsive" required>
                        </div>
                        <!-- <div class="field ">
...
?>
    ...
    <footer>
        <span>Created By <a href="team/team.html"target="_blank">Team AK</a>  <span class="far fa-copyright"></span> All rights reserved of 2023.</span>
    </footer>
